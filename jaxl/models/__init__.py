...
def get_optimizer(
    ...
    :rtype: Union[Tuple[Dict[str, Any], Dict[str, Any]], Tuple[optax.GradientTransformation, optax.OptState]]
...
def get_update_function(
    ...
    :rtype: Callable[[optax.GradientTransformation, Union[Dict[str, Any], chex.Array], optax.OptState, optax.Params], Tuple[Any, Any]]
