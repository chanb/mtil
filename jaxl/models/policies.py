...
from jaxl.distributions import Normal, Softmax
...
class DeterministicPolicy(Policy):
    ...
    def make_compute_action(
        ...
        :rtype: Callable[[Union[optax.Params, Dict[str, Any]], chex.Array, chex.Array, jrandom.PRNGKey],Tuple[chex.Array, chex.Array],]
    ...
    def make_deterministic_action(
        ...
        :rtype: Callable[[Union[optax.Params, Dict[str, Any]], chex.Array, chex.Array],Tuple[chex.Array, chex.Array],]
...
class GaussianPolicy(StochasticPolicy):
    ...
    def make_act_lprob(
        ...
        :rtype: Callable[[Union[optax.Params, Dict[str, Any]], chex.Array, chex.Array, jrandom.PRNGKey],Tuple[chex.Array, chex.Array, chex.Array],]
    ...
    def make_lprob(
        ...
        :rtype: Callable[[Union[optax.Params, Dict[str, Any]], chex.Array, chex.Array, chex.Array],chex.Array,]
